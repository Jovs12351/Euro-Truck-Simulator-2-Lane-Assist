...
from Plugins.NGHUD.themes import get_theme_manager
...
class Plugin(ETS2LAPlugin):
    ...
    widget_sizes = {
        _("Assist Information"): {"width": 120, "height": 50},
        _("Media"): {"width": 160, "height": 50},
        _("Speed"): {"width": 140, "height": 60},  # Enhanced speed widget needs more space
        _("RPM & Gear"): {"width": 100, "height": 50}
    }
    ...
    def ensure_renderers_selected(self):
        ...
        if renderers is None:
            self.settings.renderers = [_("ACC Information"), _("Traffic Lights"), _("Steering Line"), _("Enhanced Overlay")]
            renderers = [_("ACC Information"), _("Traffic Lights"), _("Steering Line"), _("Enhanced Overlay")]
    ...
    def run(self): 
        ...
        # Update theme manager with current time of day
        theme_manager = get_theme_manager()
        is_day_time = self.is_day()
        theme_manager.update_time_of_day(is_day_time)
